...
$query2 = mysqli_query($conn, "SELECT SUM(nominal) AS tabungan FROM tb_tabungan");
...
<body class="hold-transition sidebar-mini layout-fixed">
		...
		<div class="content-wrapper">
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1>Rp. <?php echo number_format($row2['tabungan']);?></h1>
						</div>
						<div class="col-sm-6">
								...
								<div class="table-responsive">
									<table id="example1" class="table table-bordered table-striped">
										...
										<tbody>
											<?php
											$no = 1;
											$query = "SELECT t.id_tabungan, t.id_remaja, t.nominal, r.nama_lengkap FROM tb_tabungan t INNER JOIN tb_remaja r ON t.id_remaja = r.id_remaja ORDER BY t.id_tabungan ASC";
											...
											while($row = mysqli_fetch_array($exe)) {
												...
												<tr>
													...
													<td>
														<button id="detail-tabungan" type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-detail" data-id="<?php echo $row['id_tabungan'];?>" data-remaja="<?php echo $row['id_remaja'];?>" data-nominal="<?php echo $row['nominal'];?>">Detail</button>
													</td>
												</tr>
											<?php } ?>
										</tbody>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<label for="id_remaja">Nama Remaja</label>
	...
	<script>
		$(document).on("click", "#detail-tabungan", function() {
			var idtabungan = $(this).data('id');
			var remajatabungan = $(this).data('remaja');
			var nominaltabungan = $(this).data('nominal');
			$("#modal-edit #id_remaja").val(remajatabungan);
			$("#modal-edit #nominal").val(nominaltabungan);
			$("#modal-edit #id_tabungan").val(idtabungan);
			$(".header-title").text("Info Tabungan");
		})
	</script>
	...
	if(isset($_POST['submitadd'])) {
		...
		$query = "INSERT INTO tb_tabungan(id_remaja, nominal, created, modified) VALUES ('$id_remaja', '$nominal', '$created', '$modified')";
		$exe = mysqli_query($conn, $query);
	...
	if(isset($_POST['submitupdate'])) {
		...
		$query = "UPDATE tb_tabungan SET id_remaja = '$id_remaja', nominal = '$nominal', modified = '$modified' WHERE id_tabungan = '$id_tabungan'";
		$exe = mysqli_query($conn, $query);

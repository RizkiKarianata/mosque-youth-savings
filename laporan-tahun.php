			...
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1>
								<a href="Proses/cetak-laporan-tahun" class="btn btn-primary">Cetak Laporan</a>
							</h1>
						</div>
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="beranda">Beranda</a></li>
								<li class="breadcrumb-item active">Per Tahun</li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="col-md-3">
							<div class="card">
								<div class="card-header">
									<h5 align="center">Tahun <?php echo date('Y', strtotime($row['created']));?></h5>
								</div>
								<div class="card-body">

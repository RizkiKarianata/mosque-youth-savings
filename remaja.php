...
<body class="hold-transition sidebar-mini layout-fixed">
										...
										<tbody>
											...
											while($row = mysqli_fetch_array($exe)) {
												...
												<tr>
													...
													<td>
														<button id="detail-remaja" type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-detail" data-id="<?php echo $row['id_remaja'];?>" data-nama="<?php echo $row['nama_lengkap'];?>" data-kelamin="<?php echo $row['jenis_kelamin'];?>">Detail</button>
													</td>
												</tr>
											<?php } ?>
										</tbody>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<input type="hidden" name="id_remaja" id="id_remaja">
	...
	<script>
		$(document).on("click", "#detail-remaja", function() {
			var idremaja = $(this).data('id');
			var namaremaja = $(this).data('nama');
			var kelaminremaja = $(this).data('kelamin');
			$("#modal-edit #nama_lengkap").val(namaremaja);
			$("#modal-edit #id_remaja").val(idremaja);
			$("#modal-edit #jenis_kelamin").val(kelaminremaja);
			$(".header-title").text(namaremaja);
		})
	</script>
			...
			$(".tombol-hapus").click(function() {
				...
				Swal.fire({
					...
					if(result.value) {
						$.ajax({
							type: 'POST',
							url: "Proses/hapus-remaja",
							data: data,
							success: function() {
								window.location.href='remaja';
							}
						});
					}
				});
	...
	if(isset($_POST['submitadd'])) {
		...
		$query = "INSERT INTO tb_remaja(nama_lengkap, jenis_kelamin, created, modified) VALUES ('$nama_lengkap', '$jenis_kelamin', '$created', '$modified')";
		$exe = mysqli_query($conn, $query);
	...
	if(isset($_POST['submitupdate'])) {
		...
		$query = "UPDATE tb_remaja SET nama_lengkap = '$nama_lengkap', jenis_kelamin = '$jenis_kelamin', modified = '$modified' WHERE id_remaja = '$id_remaja'";
		$exe = mysqli_query($conn, $query);

		...
		<div class="content-wrapper">
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1>
								<a href="Proses/cetak-laporan-minggu" class="btn btn-primary">Cetak Laporan</a>
							</h1>
						</div>
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="beranda">Beranda</a></li>
								<li class="breadcrumb-item active">Per Minggu</li>
							</ol>
						</div>
					</div>
				</div>
			...
			<section class="content">
				<div class="row">
					<?php
					$no = 1;
					$query = mysqli_query($conn, "SELECT SUM(nominal) AS total FROM tb_tabungan GROUP BY DAY(created)");
					while($row = mysqli_fetch_array($query)) {
						?>
						<div class="col-md-3">
							<div class="card">
								<div class="card-header">
									<h5 align="center">Minggu Ke-<?php echo $no++;?></h5>
								</div>
								<div class="card-body">
